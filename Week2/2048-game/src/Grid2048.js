...
class Grid2048 extends React.Component{
    ...
    checkMovesPossible(){
      ...
      if(!(upmove_possible || downmove_possible || leftmove_possible || rightmove_possible)){
      ...
      for(let i = 0; i < 4; i++){
        ...
        for(let j = 0; j < 3; j++){
          if(local_grid[i][j] && local_grid[i][j] === local_grid[i][j+1]){
            ...
            if(local_grid[i][j] === 2048) this.setMessageFn("You have completed 2048");
